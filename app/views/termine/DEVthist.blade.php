...
<table class="terminHist" style="border-collapse:collapse;font-size:12px;font-family:tahoma;">
    <tr>
        ...
        <td class="thHeader2" style="width:70px;">Datum</td>
        <td class="thHeader2" style="width:250px;">ToDo</td>
        <td class="thHeader2" style="width:120px;">erledigen bis</td>
        <td class="thHeader2" style="width:40px;">Ersteller</td>
        <td class="thHeader2" style="width:120px;">erledigt am</td>
        <td class="thHeader2" style="width:400px;">Bemerkungen</td>
        ...
        <td class="thHeader2" style="width:165px;">
            ...
            <div style="height:35px;padding:5px;border: none;width:90%;">
                <div style="padding-bottom:5px;">Fertige anzeigen</div>
                ...
                <tr class="thRow {{$class}}" name="{{$class}}" >
                    ...
                    <td  class="thCell" >
                        <select name="StatChange_NewReceiver_{{$log->PPTermineChanges_Id}}" id="StatChange_NewReceiver_{{$log->PPTermineChanges_Id}}">
                            ...
                            @else
                            <option selected >gelöscht</option> 
                            @endif
                            @endforeach
                        </select>
                    </td>
                    ...
                    <td class="thCell">
                    {{$log->PPTermineChanges_Categorie}}
                    </td>
                    ...
                    <td  class="thCell" >
                        @if (isset($mitarbeiterliste[$log->PPTermineChanges_Mitarbeiter_Id])){{$mitarbeiterliste[$log->PPTermineChanges_Mitarbeiter_Id]}} @else gelöscht @endif
                    </td>
                    ...
                    <td class="thCell" style="padding:0px;">
                        <div style='background-color:#c0c0c0;padding:4px;color:#003D7C;border: 1px solid #003D7C;'>Bemerkung Ersteller</div>
                        <textarea {{$RemarkDisabled}} id="StatChange_NewRemark_{{$log->PPTermineChanges_Id}}" style="width:100%; height:60px;border:none;">{{$log->PPTermineChanges_Remark}}</textarea>
                        <div  style='background-color:#c0c0c0;padding:4px;color:#003D7C;border: 1px solid #003D7C;'>Bemerkung Zuständig</div>
                        <textarea {{$RemarkRecDisabled}} id="StatChange_NewRemarkReceiver_{{$log->PPTermineChanges_Id}}" style="width:100%; height:60px;border:none;">{{$log->PPTermineChanges_RemarkReceiver}}</textarea>
                    </td>
