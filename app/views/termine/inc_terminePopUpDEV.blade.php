...
<script src="https://code.jquery.com/ui/1.13.0/jquery-ui.min.js"></script>
    ...
    ?>
<div style="text-align:left;border:10px solid blue; width:98%;height:95%;text-align:center;min-width:1250px; {{ $_st }} overflow:auto;min-height:800px;">
    <div style="border:1px solid lime;padding:10px;max-height:25%;">
        <div class='msContainer'>
            @foreach ($termineLinks as $tm)
            <div class="msCell tabSim" onclick="ajax_getTerminTab({{$pp['id']}}, {{$tm->PPTermine_Id}}, {{$board}}, 'All', 1)" @if($tm->PPBoardSpalte_Bezeichnung == $t['terminart']) style="background-color:#7089e1;color:black;" @endif>
    ...
    <div class="overlay" id="div_{{$t['id']}}" style="padding:0px;overflow: auto;z-index:10000;border:2px solid dodgerblue;height:82%;">
        <div style="position:relative; margin: 0 auto;border:2px solid green;border-radius: 0px;padding:8px; text-align: center;height:96%;overflow:auto;">
            <div style="margin:0 auto;border:2px solid pink;border-radius: 0px;height:98%;overflow:auto;">
                <div style="border:1px solid gray;border-radius: 0px;position:relative;">
                    <div id="boxHistory" style="border:4px solid dodgerblue;height:250px;width:1000px;overflow:auto;text-align: left;display:none;position:absolute;top:0%;left:0%;background-color:gray;">
                        <textarea style="width:80%;height:70%;padding:5px;margin-left:10%;">{{ str_replace('*','',str_replace('* ', '', $t['history'])) }}</textarea>
                        ...
                        <form id="frm{{$t['id']}}" Method="post" action="#" enctype="multipart/form-data">
                            ...
                            <fieldset style="border:none; padding-bottom:0px;">
                                <div style="border:none;padding-bottom:0px;">
                                    <?php
                                        $_stat = "Status: In Arbeit: ".$t['Header2'][$t['spalteId']]->PPBoardSpalteData_HifeStatusInArbeit.PHP_EOL."Status OK: ".$t['Header2'][$t['spalteId']]->PPBoardSpalteData_HilfeStatusOK.PHP_EOL."Status Nicht OK:".$t['Header2'][$t['spalteId']]->PPBoardSpalteData_HilfeStatusNOK; 
                                    ?>
                                    <div style="border:1px solid leughtgray;">
                                        <table id="data1">
                                            <tr>
                                                <td class="label" style="width:100px;">Terminart: <span style="color:green; font-weight:bold; font-size:1.2rem;"></span><img src="{{url($iconInfo)}}"  style="width:16px;float:right;" title="{{$_stat}}"/></td>
                                                <td class="value" style="width:250px;">{{$t['terminart']}}</td>
                                                ...
                                                <td class="value" style="width:300px;"> @if ($t['rot'] != '' or $t['rot'] == 0 )Soll: CRD {{$t['rot'] +10}} Wochen @endif
                                                    KW @if ($crd->format('W')+$t['rot']+10 <  0){{$crd->format('W')+$t['rot']+62}}/{{$crd->format('y')-1}} @else @if ($crd->format('W')+$t['rot']+10 > 52 )  {{$crd->format('W')+$t['rot']-42}}/{{$crd->format('y')+1}} @else  {{$crd->format('W')+$t['rot']+10}}/{{$crd->format('y')}}@endif @endif
                                                </td>
                                                <td class="label" style="width:150px;" title="In der Terminliste mit '*' gekennzeichnet">man. Soll: <span style="color:darkblue;font-weight:bold;">(*)</span></td>
                                                <td class="value" style="width:250px;"> <div style="margin-top:8px;">CRD - <input disabled style="padding:5px; width:60px;" name="Termine_ManSoll{{$t['id']}}" id="Termine_ManSoll{{$t['id']}}" value="{{ $wochen??''}}" /> Wochen 
                                                    @if ($t['ManSoll'] != 0) => KW
                                                ...
                                                <td class="label" style="width:150px;">PM</td>
                                                <td class="value" style="width:250px;">{{ isset($mitarbeiterNamen[$pp['PM']]->PPMitarbeiter_Kuerzel)?$mitarbeiterNamen[$pp['PM']]->PPMitarbeiter_Kuerzel:"N.N.";  }}   <b></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="value">{{ isset($mitarbeiterNamen[$pp['TC']]->PPMitarbeiter_Kuerzel)?$mitarbeiterNamen[$pp['TC']]->PPMitarbeiter_Kuerzel:"N.N.";  }}   <b></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div style="border:none;">
                                        <table id="data2">
                                           <tr>
                                                <td colspan=9 class="iHLabel">
                                                        <span style="font-size: 15px; font-weight: bold;padding: 0px; padding-top:8px; padding-bottom: 8px;color:#003D7C;">Hauptaufgabe </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="iHLabel" style="width:132px;">Status</td>
                                                <td class="iHLabel" style="width:270px;">Zuständig</td>
                                                <td class="iHLabel" style="width:132px;">Manueller Soll</td>
                                                <td class="iHLabel" style="width:132px;" title="In der Terminliste mit '.' gekennzeichnet">erledigen bis <span style="color:darkblue;font-weight:bold;">(.)</span></td>
                                                <td class="iHLabel" style="width:132px;">erledigt am</td>
                                                <td class="iHLabel">Anzeigetext</td>
                                                <td class="iHLabel">Bemerkung</td>
                                                <td class="iHLabel" style="width:68px;">store</td>
                                                <td class="iHLabel" style="width:68px;">History</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="iHValue" style="text-align:center;padding:0px;"> @if (Auth::User()->PPMitarbeiter_Gruppe == 'user' or Auth::User()->PPMitarbeiter_Gruppe == 'admin')
                                                ...
                                                <td class="iHValue" style="padding:0px;">
                                                   <button type="button" onclick="History(0);" style="width:100%;margin:0px;height:100%;">History</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">
                    ...
                    <div style="padding: 0px; border: 1px solid #003D7C; border-radius: 0px;  padding:10px; margin-top: 8px;">
                        <div style="padding-top: 4px; padding-bottom: 4px;text-align: left;">
                            <span style="font-size:15px; font-weight: bold;padding: 5px; padding-top:8px; padding-bottom: 8px;color:slategray;">Unteraufgabe</span>
                        </div>
                        <div style="border:none;">
                            <div style="border:none;">
                                <form id="frmTheme{{$t['id']}}" Method="post" action="#" enctype="multipart/form-data">
                                    ...
                                    <div class="hist" style="border:none;">
                                        <table id="data3" style="margin-top:10px;border-radius: 10px;border-collapse: collapse;">
                                            <tr>
                    ...
                    <div style="border:none;height:340px; overflow: auto;padding:0px;margin-top:8px;">
                        ...
                        <div style='border:1px solid #003D7C;overflow: auto;height:200px;margin-top:8px;border-radius: 0px;'>
                            @include('termine.DEVthist')
                        </div>
                    </div>
                </div>
            </div>
