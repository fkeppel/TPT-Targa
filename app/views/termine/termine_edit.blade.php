<div style="position:relative;">
    <div class="overlay" id="div_{{$id}}" style="border:none;width:400px;height:480px;position:fixed;top:10%;left:40%;">
        <div style="position:relative; margin: 0 auto;border:1px solid gray;height:480px;background-color: #c0c0c0;">
            <div style="margin:0 auto;background-color:#c0c0c0;border: none;height:390px;">
                {{ Form::open() }}
                <input type="hidden" name="Termine_Id{{$id}}" value="{{$id}}">
                <fieldset style="width:360px;margin-top:-10px;height:385px;">
                    ...
                    <div style="width:335px;background-color: #c0c0c0;padding:8px;color:darkblue;">
                    ...
                    <div style="width:335px;background-color: #c0c0c0;padding:8px;vertical-align: top;color:darkblue;">
                    ...
                    <div style="width:335px;background-color: #c0c0c0;padding:8px;vertical-align: top;color:darkblue;margin-top: -10px;">
            ...
            <div style="text-align: center;background-color: #c0c0c0;padding:15px;">
                <button id="ajaxCall_SaveDateX"  onclick="cpc_tsave('{{$id}}');" style="width:360px;">
                    Speichern
                </button>
