                    ...
                    <form id="frm{{$t['id']}}" Method="post" action="#" enctype="multipart/form-data">
                        ...
                        <fieldset style="border:none; padding-bottom:0px;">
                            <div style="padding-top: 8px; padding-bottom: 8px;text-align: left;">
                                <span style="font-size: 18px; font-weight: bold;padding: 5px; padding-top:8px; padding-bottom: 8px;color:#003D7C;">{{ ServiceProvider::tl($lang, 'Hauptaufgabe') }}</span>
                            </div>
                            <div style="border:none;height:284px;">
                                <div style="border:none; margin-bottom: 0px; ">
                                    <div style="border: none;float: left; padding-bottom:0px;">
                                        <table id="data1">
                                            <tr>
                                                <td class="label" style="width:140px;">
                                                    <div class='tooltip'> {{ ServiceProvider::tl($lang, 'Terminart') }}:
                                                    <img src="{{url($iconInfo)}}"  style="width:12px;float:right;" /> 
                                                ...
                                                <td class="value" style="width:400px;"> {{ ServiceProvider::tl($lang,$t['terminart']) }} </td>
                                                <td class="label" style="width:150px;">{{ ServiceProvider::tl($lang,'Meilenstein') }}: {{-- $crd->format('W') --}}</td>
                                                <td class="value" style="width:300px;"> @if ($t['rot'] != '' or $t['rot'] == 0 ) {{ ServiceProvider::tl($lang, 'Soll')}}: CRD {{$t['rot'] +10}} {{ ServiceProvider::tl($lang, 'Wochen') }} @endif
                                            ...
                                            <tr>
                                                <td class="label">{{ ServiceProvider::tl($lang, 'Status')}}:</td>
                                                <td class="value">{{$pp['InternerStatus']}}</td>
                                                <td class="label">DDP:</td>
                                                <td class="value">{{$pp['ddpltw']}}/{{$pp['ddplty']}}</td>
                                            </tr>
                                            <tr>
                                                <td class="label">{{ $t['PMPJMTC'] }}</td>
                                                ...
                                                <td class="label" title="In der Terminliste mit '*' gekennzeichnet">{{ ServiceProvider::tl($lang, 'man. Soll')}}: <span style="color:darkblue;font-weight:bold;">(*)</span></td>
                                        ...
                                        <table id="data2">
                                            <tr>
                                                <td class="iHLabel" style="width:132px;">{{ ServiceProvider::tl($lang, 'Status')}}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="iHValue" style="padding:0px;">
                                                    <textarea class="text1" name="Termine_Label{{$t['id']}}" id="Termine_Label{{$t['id']}}">{{ ServiceProvider::tl($lang, $t['label'])}}</textarea>
                                                </td>
                                                <td class="iHValue" style="padding:0px;">
                                                    <textarea class="text1" name="Termine_Bemerkung{{$t['id']}}" id="Termine_Bemerkung{{$t['id']}}">{{ ServiceProvider::tl($lang, $t['bemerkung'])}}</textarea>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="7">
                                                    <table style="font-size:0.7rem;font-weight: bold;color:gray;">
                                                        <tr>
                                                            <td style="width:100px;padding:0px;">{{ ServiceProvider::tl($lang, 'In Arbeit')}}:</td>
                                                            <td style="padding:0px;">{{ ServiceProvider::tl($lang, $t['Header2'][$t['spalteId']]->PPBoardSpalteData_HifeStatusInArbeit) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding:0px;">{{ ServiceProvider::tl($lang, 'Status OK')}}:</td>
                                                            <td style="padding:0px;">{{ ServiceProvider::tl($lang, $t['Header2'][$t['spalteId']]->PPBoardSpalteData_HilfeStatusOK) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding:0px;">{{ ServiceProvider::tl($lang, 'Status Nicht OK')}}:</td>
                                                            <td style="padding:0px;">{{ ServiceProvider::tl($lang, $t['Header2'][$t['spalteId']]->PPBoardSpalteData_HilfeStatusNOK) }}</td>
                                                        </tr>
                                                    </table>  
                                                </td>
                                            </tr>
