...
?>
<div id="RFQ" style="width:2000px; height:877px; text-align:left; overflow:auto;border:1px solid lightgray; padding-left:25px; text-align:left; border-radius:0px;">
...
<h1>RFQ</h1>    
    <form action="/saveTranslation" method="POST">
        <div style="text-align:left;">
            ...
            <div class="container" >
                @foreach ($data['translation'] as $key =>  $trans)
