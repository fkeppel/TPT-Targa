                ...
                <table id='tptTableCarton' style="margin:4px;margin-left:210px;">
                  ...
                  <table id='tptTableCarton' style="margin:4px;margin-left:210px;">
                    ...
                    @for($i=0;$i<15;$i++)
                        ...
                        ?>
                    <tr>
                        <td><input style='text-align:left;' name="container[{{$pcvId}}][Hafen]" value='{{$hafen}}'/></td>
                        <td><input name="container[{{$pcvId}}][Menge]"  value='{{$menge}}' /></td>
                        <td><input name="container[{{$pcvId}}][C40]"  value='{{$cv40}}' /></td>
                        <td><input name="container[{{$pcvId}}][C20]"  value='{{$cv20}}' /></td>
                    </tr>
                    @endfor
                    <!--tr>
