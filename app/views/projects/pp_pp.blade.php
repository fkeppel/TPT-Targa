...
<div id="idProduktpass" style="border:1px solid lightgray;padding-top:0px;" >
    ...
    <div style="margin:0 auto;text-align:left;width:110px; z-index: 100;padding-top:8px;border:none;height:40px;margin-left:0px;">
        {{ Form::submit('speichern', array('class'=>'btn','style'=>'width:120px;background-color: #1C73C5;border-radius:0;color:white;'))}}
    </div>
    @endif
        ...
        <?php 
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li>
                        {{ Form::label('Artikelbezeichnung LIDL') }} 
                        <textarea  cols="50" rows="10">{{ $data['pp']['PPProduktpass_Artikelbezeichnung'] }}</textarea>                        
                    </li>
                    <li>
                        {{ Form::label('Artikelbezeichnung TARGA') }} 
                        @if ($changeArtT)
                            <img src="{{url('/data/Icons/AusrufeZeichen.png')}}" title="{{ $titleArtT }}" style="height:20px;margin-top:6px;">
                        @endif
                        <?php 
                            $bez = $data['pp']['PPProduktpass_Artikelbezeichnung'];
                            if(!is_null($data['pp']['PPProduktpass_ArtikelTarga']) or strlen(trim($data['pp']['PPProduktpass_ArtikelTarga']) > 0)){
                                $bez = $data['pp']['PPProduktpass_ArtikelTarga'];
                            }
                        ?>
                        <textarea @if ($changeArtT) style="width:322px;" @endif name="PPProduktpass_ArtikelTarga" cols="50" rows="10">{{ $bez }}</textarea>                        
                    </li>
                    <!--li>
...
'.$ty;
                        ...
                        ?>
                        {{ Form::label('CRD (KW/Jahr)') }}
                        @if ($change)
                        <img src="{{url('/data/Icons/AusrufeZeichen.png')}}" title="{{ $title }}" style="height:20px;margin-top:6px;">
                        @endif
                        {{ Form::text('PPProduktpass_CRDWoche',NULL,array('style'=>'width:60px;')) }}{{ Form::text('PPProduktpass_CRDJahr',NULL,array('style'=>'width:60px;')) }}<br>
                        <?php
                        $lbl   = "CRD (KW/Jahr)";
                        $attr  = "PPProduktpass_CRDWoche";
                        $attr1 = "PPProduktpass_CRDJahr";
                        $lbl   = $lbl . " Rev";
                        if ($data["ShowDiff"] and ( $data['pprev']->{$attr} != $data['pp']->{$attr})) {
                            ?>
                            {{ Form::label($lbl) }}{{ Form::text('D',$data['pprev']->{$attr},array('style'=>'color:red;width:60px;')) }}{{ Form::text('D',$data['pprev']->{$attr1},array('style'=>'color:red;width:60px;')) }}
        ...
        <div style="float:left;width:750px; margin-left:10px;">
            <fieldset>
                ...
                <ul>
                    ...
                    <input name='PPProduktpass_IsUSA' type="hidden" value='0' />
                    <div style="width:400px;height:80px;float:left;text-align:left;padding:6px;">
                        <div style='text-align:left;float:left;'><input name='PPProduktpass_IsParent'   type="checkbox" value="1" @if( $data['pp']->PPProduktpass_IsParent ) checked=checked @endif   style='width:30px; height:20px;'/> <div style='display:inline-block;width:120px;font-weight:bold;padding-top:4px;'>Parent</div></div>
                        <div style='text-align:left;float:left;'><input name='PPProduktpass_IsChild'    type="checkbox" value="1" @if( $data['pp']->PPProduktpass_IsChild ) checked=checked @endif    style='width:30px; height:20px;'/> <div style='display:inline-block;width:120px;font-weight:bold;padding-top:4px;'>Child</div></div>
                        <div style='text-align:left;float:left;'><input name='PPProduktpass_IsKaufland' type="checkbox" value="1" @if( $data['pp']->PPProduktpass_IsKaufland ) checked=checked @endif style='width:30px; height:20px;'/> <div style='display:inline-block;width:120px;font-weight:bold;padding-top:4px;'>Nachbestellung</div></div>
                        <div style='text-align:left;float:left;'><input name='PPProduktpass_IsUSA' type="checkbox" value="1" @if( $data['pp']->PPProduktpass_IsUSA ) checked=checked @endif style='width:30px; height:20px;'/> <div style='display:inline-block;width:100px;font-weight:bold;padding-top:4px;'>USA Projekt</div></div>
                    </div>
                    <div style="clear: both;">&nbsp;</div>
                    </li>
                    <li>
