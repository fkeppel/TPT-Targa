...
<?php
    ...
    if (Auth::user()->PPMitarbeiter_Kuerzel == 'MM_admin'){
        $showEdit2 = true;
    }
...
<div  style="border:1px solid gray;border-radius:0px;position:relative;height:100%;overflow:auto;">
    ...
    <div id="tabContainer" style="border:none;height:99%;overflow: auto;">
        <div id="tabs2" style="border:none;height:98%;">
            <ul>
                <?php $tbid      = 0; ?>
            ...
            <div id="{{$type['Type']}}" style="height:97%;overflow:hidden;padding:0px; border:1px solid lightgray;" >
                <?php $tabid++; ?>
                <div id="tabs{{$tabid}}" style=" border:1px solid lightgray;">
                    <ul>
                        <?php $subcatndx = 0 ?>
                                ...
                                <div id='fileUpload' style="border:1px solid lightgray;padding:10px;">
                                    ...
                                    <form name="UplD" id="{{  $kat['Kategorie'] }}" action="/uploadFiles" method="post" enctype="multipart/form-data" style="margin: 0 auto;" onsubmit="return validateUpload('{{ $kat['Kategorie'] }}')">
                                        ...
                                        <fieldset class="cpcFileUpload"> 
                                            ...
                                            <button type="submit" style="height:40px;padding:6px;margin-left:9px;margin-top:0px;width:91.5%;border:1px solid darkblue;"><b>Upload</b></button>
                                        </fieldset>
                                    </form>
                                </div>
                        </div>   
                                    ...
                                    <div style="position:relative;border: 1px solid lightgray;margin-bottom: 10px;padding-top:10px;padding-left:10px;">
                                              ...
                                              <?php 
                                                ...
                                                @if($isSharepoint)
                                                    ...
                                                    <a href="{{  ViewController::getSpoLink($file['PPPPFiles_Id'],1) }}" download="{{ViewController::getSpoDLName($file['PPPPFiles_Id'],1)}}" target="_blank">
                                                       <img src="{{url($dllogo)}}" style="margin:0 auto;width:80%;border:none;">
                                                    </a>
                                                @else 
                                                    ...
                                                    <a href="{{$server.'/data/'.$file['PPPPFiles_Pfad'].'/'.$file['PPPPFiles_TPTFilenameOld']}}" download="{{$file['PPPPFiles_TPTFilenameOld']}}" target="_blank">
                                                        <!--img src="{{url('https://targagmbh.sharepoint.com/:i:/r/sites/TPTStorage/Freigegebene%20Dokumente/IANs/445217_2307/445217.JPG?csf=1&web=1&e=MlYFmF')}}" style="height:80%;border:none;"-->
                                                         <img src="{{url($spo_file)}}" style="height:80%;border:none;">XXXX
                                                    </a>
                                                    @else
                                                    <a href="{{$server.'/data/'.$file['PPPPFiles_Pfad'].'/'.$file['PPPPFiles_TPTFilenameOld']}}" download="{{substr($file['PPPPFiles_TPTFilenameOld'],7)}}" target="_blank">
                                                         <img src="{{$server.'/data/'.$file['PPPPFiles_Pfad'].'/'.$file['PPPPFiles_TPTFilenameOld']}}" style="margin:0 auto;height:80%;border:none;">AAAA
                                                    </a>
                                                    @endif
                                                @endif
                                            </div>
                                        ...
                                        @else
                                            <div style="border:1px solid gray;">
                                                ...
                                                @endif
                                                @if (strlen($dllogo)> 10)
                                                    <img src="{{$dllogo}}" alt="Datei" style="margin:0 auto;height:80%;border:none;">
                                                @else
                                            ...
                                            <div class="cell">
                                                <div style="padding:5px;border:none;">
                                                    ...
                                                    @else
                                                        ...
                                                        ?>
                                                            <a href="{{$link}}">Sharepoint</a>
                                                        @else
                                                            @if ($type['Type'] == 'PPUpload')
                                                            <a href="{{url('/data/'.$file['PPPPFiles_Pfad'].'/'.$file['PPPPFiles_Name'])}}" download="{{$file['PPPPFiles_Name']}}" target="_blank" title="{{$file['PPPPFiles_Description']}}"> {{$dlSymbol}} {{$file['PPPPFiles_Name']}} </a>
                                                            @else
                                                            <a href="{{url('/data/'.$file['PPPPFiles_Pfad'].'/'.$file['PPPPFiles_Name'])}}" download="{{substr($file['PPPPFiles_Name'],7)}}" target="_blank" title="{{$file['PPPPFiles_Description']}}">{{$dlSymbol}} {{substr($file['PPPPFiles_Name'],7)}}</a>
                                                            @endif
                                                        @endif
                                                    @endif
                                                </div>
