<div style="background-color: #FFF; border:1px solid gray;border-radius: 5px; width:1638px;height:895px;text-align: left;padding:30px; font-family: Tahoma; font-size: 14px;">
    ...
    <div style="float: left;width:600px; border:4px solid lightgray; margin-left: 20px;padding:20px; height: 586px;">
        <h2 style="color:red;">Zip-Archiv</h2>
        <div>
            <form method="POST" action="/uploadMassenImport" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return eval_form();">
                <div style="width:500px;vertical-align:text-top;font-size: 15px; border:1px solid lightgray;height:227px; padding:20px;">
                    ...
                    <div style="width:400px;float:left;vertical-align: text-top;font-size: 15px;height:40px; padding:0px;">
                        ...
                        <input   accept="*.xml *.zip" type="file" name="MultiZip" style="font-size:20px;margin-top: 15px;width:400px;height: 30px;"/></div>
                ...
                <div style="width:500px;height:240px;border: 1px solid lightgray;padding:10px;margin-top: 15px; padding: 0 0 0 20;">
                    ...
                    Woche: <input name="LTWoche" style="font-size:20px;width:100px;height: 30px;margin-right:30px;  text-align:right;" value='99'/>  Jahr: <input name="LTJahr" style="font-size:20px;width:100px;height: 30px; text-align:right;"  value='9999'/>
                    </div>
