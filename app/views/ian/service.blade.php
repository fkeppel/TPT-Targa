            ...
            <div style="margin-bottom:30px;">
                <form action="/updateInputManuellNeu" id="FormPM" method="post" onsubmit="return valFormPM();">
                    ...
                    <div class='inpGrid'>
                        ...
                        <div class='inpValue'><input {{$disabled}} autocomplete="off" style="{{ $data['InpManCompare']['PPInputManuell_Projektname']['Style'] }}" title="{{ $data['InpManCompare']['PPInputManuell_Projektname']['OldValue'] }}" type="text" name='man[PPInputManuell_Projektname]' value="{{$data['InpMan']->PPInputManuell_Projektname}}" /></div>
                        <div></div>
                        ...
                        <div class='inpValue' style='grid-column: 2 /-1;'>
                            ...
                            <div style="float:left;">
                                <table id='tptTableCarton'>
                                    ...
                                    <tr>
                                        <td style="padding:8px;">{{ ServiceProvider::tl($lang, 'Giftbox') }}
                                            <div class="tooltip" style="float:right; cursor:pointer;">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24"
                                                    width="18"
                                                    height="18">
                                                    <circle cx="12" cy="12" r="10" fill="var(--tgBlue)"/>
                                                    <rect x="11" y="10" width="2" height="7" fill="#ffffff"/>
                                                    <circle cx="12" cy="7" r="1.4" fill="#ffffff"/>
                                                </svg>
                                                <span class="tooltiptext">Maße gelten nur für eine Giftbox!</span>
                                            </div>
                                        </td>
                                        <td><input {{$disabled}} style="{{ $data['InpManCompare']['PPInputManuell_VEGB1']['Style'] }}" title="{{ $data['InpManCompare']['PPInputManuell_VEGB1']['OldValue'] }}" type="text" name='man[PPInputManuell_VEGB1]' value="{{number_format($data['InpMan']->PPInputManuell_VEGB1,0,',','.')}}" /></td>
                                    ...
                                    <tr>
                                        <td style="padding:8px;">{{ ServiceProvider::tl($lang, 'Giftbox 2') }}
                                             <div class="tooltip" style="float:right; cursor:pointer;">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24"
                                                    width="18"
                                        ...
                                        <td><input {{$disabled}} style="{{ $data['InpManCompare']['PPInputManuell_VEGB2']['Style'] }}" title="{{ $data['InpManCompare']['PPInputManuell_VEGB2']['OldValue'] }}" type="text" name='man[PPInputManuell_VEGB2]' value="{{number_format($data['InpMan']->PPInputManuell_VEGB2,0,',','.')}}" /></td>
