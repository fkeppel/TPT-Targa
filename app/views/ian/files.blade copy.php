...
?> 
<div style='width:calc(100% - 20px);height:calc(100% - 100px);overflow:auto;border:4px solid red'>
<div  style="border:1px solid gray;border-radius:0px;position:relative;height:100%;overflow:auto;">
    ...
    <div id="tabContainerFiles" style="border:none;height:99%;overflow: auto;">
        <div id="tabsFiles" style="border:none;height:98%;">
            <ul>
                <?php $tbid      = 0; ?>
            ...
            <div id="{{$type['Type']}}" style="height:97%;overflow:hidden;padding:0px; border:1px solid lightgray;" >
                <?php $tabid++; ?>
                <div id="tabFilesSub{{$tabid}}" style=" border:1px solid lightgray;">
                    <ul>
                        <?php $subcatndx = 0 ?>
