...
class PPProduktpass_Menge extends Eloquent {

    protected $primaryKey = 'PPProduktpass_Menge_Id';
    protected $table = 'PPProduktpass_Menge';
    public $timestamps = false;

    public function scopePP($query, $ppid) {
        return $query->where('PPProduktpass_Menge_PPProduktpass_Id', '=', $ppid);
    }
